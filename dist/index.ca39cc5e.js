...
window.onload = function() {
    ...
    headerbutton.addEventListener("click", ()=>{
        ...
        let service = new _service.Service(headerinput.value);
...
},{"../models/service":"92n4e"}],"92n4e":[function(require,module,exports) {
...
class Service {
    ...
    getData() {
        return fetch("http://www.omdbapi.com/?i=tt3896198&apikey=9a5cc6b6&s=" + this.title + "&type=movie").then((response)=>response.json()
        ).then((data)=>{
            return data;
        });
    }
